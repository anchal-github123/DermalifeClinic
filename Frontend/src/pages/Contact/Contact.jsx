...
export default function Contact() {
  return (
    <>
      ...
      <head>
        <title>Contact Dermalife Cuttack | Skin, Hair & Laser Clinic</title>
        <meta
          name="description"
          content="Contact Dermalife Skin & Laser Clinic Cuttack for appointments, skincare consultations, laser treatments, and aesthetic services. Call or find directions on Google Maps."
        />
      </head>
      ...
      <section className="w-full py-4 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-primary">Contact Dermalife Clinic</h1>
            ...
            <div className="bg-white shadow-lg p-8 rounded-2xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    <a
                      href="mailto:Dermalife.cuttack@gmail.com"
                      className="hover:text-[#0F1D80]"
                    >
          ...
          <div className="flex justify-center gap-5 mt-10">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-white shadow-md rounded-full hover:bg-gray-200"
            >
              <Facebook size={22} />
            </a>

            <a
              href="https://www.instagram.com/dermalife.cuttack"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-white shadow-md rounded-full hover:bg-gray-200"
            >
          ...
          {/* Map Section */}
          <div className="mt-16">
            <h2 className="text-2xl font-semibold mb-4 text-[#0F1D80]">
              Find Us on Google Maps
            </h2>

            <div className="w-full h-[350px] rounded-xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6656.441154556385!2d85.89199699013507!3d20.466836137283966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a190dd6b634c04b%3A0xce7e57807771781b!2sDermalife!5e0!3m2!1sen!2sin!4v1764489985062!5m2!1sen!2sin"
                width="100%"
                height="100%"
                loading="lazy"
                allowFullScreen
                referrerPolicy="no-referrer-when-downgrade"
                title="Dermalife Clinic Location"
              ></iframe>
            </div>
          </div>
